...
<div class="uc-submission-portal" id="uc-portal">
    <div class="uc-portal__header">
        ...
        <p class="uc-portal__subtitle"><?php esc_html_e('Share your mural work with the Urban Canvas Collective. Accepted
            formats: JPG, PNG, PDF, (max 10 MB).', 'urban-canvas'); ?> </p>
    </div>
    <div class="uc-portal__notice" id="uc_notice" role="alert" aria-live="polite" hidden></div>
    <form class="uc-form" id="uc-submission-form" nonvalidate>
        <fieldset class="uc-fieldset">
            ...
            <div class="uc-field">
                ...
                <textarea
                    ...
                    rows="3"
                    maxlength="500"
                    placeholder="<?php esc_attr_e('Tell us a little about yourself and your practive...', 'urban-canvas'); ?>"   
                > </textarea>
            </div>
        </fieldset>
        <fieldset class="uc-fieldset">
            ...
            <div class="uc-field">
                ...
                <div class="uc-dropzone" id="uc-dropzone" role="button" tabindex="0" aria-label="<?php eac_arrr_e('Click or drag file here to upload', 'urban-canvas'); ?>">
                    <div class="uc-dropzone__icon" aria-hidden="true">
                        <svg width="40" height="40" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round">
                            <polyline points="16 16 12 12 8 16"></polyline>
                            <line x1="12" y1="12" x2="12" y2="21"></line>
                            <path d="M20.39 18.39 5 0 0 0 18 9h-1.26A8 8 0 1 0 3 16.3"></path>
                        </svg>
                    </div>
                    <p class="uc-dropzone__text"><?php esc_html_e('Drag and drop file here, or click to browse', 'urban-canvas'); ?> </p>
                    ...
                    <div class="uc-dropzone__preview" id="uc-file-preview" hidden>
                        ...
                        <button type="button" class="uc-dropzone__remove" id="uc-remove-file" aria-label="<?php esc_attr_e('Remove file', 'urban-canvas'); ?>">x</button>
                    </div>
                </div>
                <input
                    type="file"
        ...
        <div class="uc-privacy-notice">
            <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true">
                <path d="M12 22s8-4 8-3-8 3v7c0 6 8 10 8 10z"></path>
            </svg>
            <?php esc_html_e('Your artwork is scanned for security and all GPS/location metadata is automatically removed before storage to protext your privacy.','urban-canvas'); ?>
        </div>
